...
func InitServiceCustomer(repo customer.Repository) customer.CustomerInt {
...
func TestRegisterCustomer(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		s := customer.NewCustomerService(mockRegisterUserrepo)
...
func TestGetCustomerById(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		mockGetCustomerById.On("GetCustomerById", id).Return(testCase, testCase.expectError)

		s := customer.NewCustomerService(mockGetCustomerById)
