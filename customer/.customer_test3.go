...
func TestCreateCustomer2(t *testing.T) {
	// Create database connection
	dbname := os.Getenv("DB_name")
	db, err := connectDB(dbname)
	if err != nil {
...
// 		reqBody := url.Values{}
// 		reqBody.Set("phone", testCase.phone)
// 		res, err := http.PostForm("http://127.0.0.1:8000/phone", reqBody)
// 		gin.H
// 		require.Nil(t, err)
...
// 		assert.Equal(t, testCase.expectCode, code)
// 		assert.True(t, strings.Contains(string(data), testCase.expectMsg))
// 	}
// }
