...
// 	idChart, err := strconv.Atoi((c.Query("id")))
// 	if err != nil {
// 		response := APIResponse("failed", http.StatusInternalServerError, err.Error(), nil)
...
// 	shopcartid, err := strconv.Atoi((c.Query("shopcart_id")))
// 	if err != nil {
// 		response := APIResponse(err.Error(), http.StatusInternalServerError, "failed", nil)
// 		c.JSON(http.StatusInternalServerError, response)
// 		return
...
// 	cartid, err := strconv.Atoi((c.Query("shopcart_id")))
// 	if err != nil {
// 		response := APIResponse(err.Error(), http.StatusInternalServerError, "failed", nil)
// 		c.JSON(http.StatusInternalServerError, response)
// 		return
